# -*- coding: utf-8 -*-
"""Reference cospectrum models used for plotting in FREQCOR.

This module provides reference (co)spectrum parameterizations used for
visualisation and comparison against measured (co)spectra.

Currently implemented models include:
- Kaimal (1972)-type cospectrum parameterizations.
- Kaimal cospectrum shape as implemented in EddyPro.
...
def Massman_cosp(nf, kf, zL, A0, kf0, mu):
