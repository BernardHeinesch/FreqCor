...
```{image} ../2_all_individual_co2__BE-Lon__co2__cosp__all__260405T1316.png
...
```{image} ../3_filtering_cof_gas__BE-Lon__co2__cosp__all__260405T1316.png
:alt: Cut-off frequency filtering (example output)
```

```{image} ../3_filtering_CF_H_unst__BE-Lon__co2__cosp__all__260405T1316.png
...
```{image} ../4_mean_TF_all_classes__wd1__BE-Lon__co2__cosp__all__260405T1316.png
:alt: Mean transfer functions by class (example output)
```

```{image} ../4_mean_cosp_all_classes__wd1__BE-Lon__co2__cosp__all__260405T1316.png
...
```{image} ../5_CF_vs_ws__st__BE-Lon__co2__cosp__all__260405T1316.png
:alt: Correction factors vs wind speed (stable) (example output)
```

```{image} ../5_CF_vs_ws__unst__BE-Lon__co2__cosp__all__260405T1316.png
